<?php
    class MY_Controller extends CI_Controller
    {
		...
		public function usr_safe_grade($speed=0){
			$safe_grade = array();
			if($speed<=30){
				$safe_grade['speed'] = '<div class="main-nav-anquanjibie-inner bg_red bai33" style="width:'.$speed.'%"></div>';
				$safe_grade['grade'] = '低';
				return $safe_grade;
			}
			if($speed<=60){
				$safe_grade['speed'] = '<div class="main-nav-anquanjibie-inner bg_blue bai66" style="width:'.$speed.'%"></div>';
				$safe_grade['grade'] = '中';
				return $safe_grade;
			}
			if($speed<=80){
				$safe_grade['speed'] = '<div class="main-nav-anquanjibie-inner bg_green2 bai100" style="width:'.$speed.'%"></div>';
				$safe_grade['grade'] = '高';
				return $safe_grade;
			}
			if($speed<=100){
